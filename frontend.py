...
def insrt():
    list1.delete(0,END)
    backend.add(t1.get(),t2.get(),t3.get(),t4.get())
    list1.insert(END,t1.get(),t2.get(),t3.get(),t4.get())

def d():
    #global selected_tuple
    backend.delet(selected_tuple[0])    

def srch():
    list1.delete(0,END)
    for row in backend.serch(t1.get(),t2.get(),t3.get(),t4.get()):
        list1.insert(END,row)

def upd():
    #global selected_tuple
    backend.updat(selected_tuple[0],t1.get(),t2.get(),t3.get(),t4.get())
